/**
 * Demo dataset — realistic fictional South African collection data (ZAR).
 *
 ...
 * Deterministic (fixed RNG seed) apart from being anchored to "now", so
 * charts and due dates always look current.
 *
